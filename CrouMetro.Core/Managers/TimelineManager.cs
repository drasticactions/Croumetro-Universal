...
namespace CrouMetro.Core.Managers
{
    ...
    {
        public static async Task<ObservableCollection<PostEntity>> GetPublicTimeline(bool? trim, long? sinceId, long? maxId, int? count,
        ...
        public static async Task<ObservableCollection<PostEntity>> GetHomeTimeline(bool? trim, long? sinceId, long? maxId, int? count,
            UserAccountEntity userAccountEntity)
        {
        ...
        public static async Task<ObservableCollection<PostEntity>> GetMentions(bool? trim, long? sinceId, long? maxId, int? count,
            UserAccountEntity userAccountEntity)
        {
            if (userAccountEntity.GetAccessToken().Equals("refresh"))
            {
        ...
        public static async Task<ObservableCollection<PostEntity>> GetUserTimeline(String screenname, long? userId, bool? trim,
        ...
        public static async Task<ObservableCollection<PostEntity>> GetConversation(PostEntity startingPost,
            UserAccountEntity userAccountEntity)
        {
            if (userAccountEntity.GetAccessToken().Equals("refresh"))
            {
            ...
            var conversationList = new ObservableCollection<PostEntity>();
